...
public extension asl_object_t
{
    ...
    public subscript(attributeName: String) -> String? {
        get {
            let value = asl_get(self, attributeName)
            if value != nil {
        ...
        set {
            if let value = newValue {
                asl_set(self, attributeName.cStringUsingEncoding(NSUTF8StringEncoding)!, value)
            } else {
                asl_unset(self, attributeName.cStringUsingEncoding(NSUTF8StringEncoding)!)
            }
        }
    }
