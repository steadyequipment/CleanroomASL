...
The [`master`](https://github.com/emaloney/CleanroomASL) branch of this project is **Swift 2.2 compliant** and therefore **requires Xcode 7.3 or higher** to compile.
...
2 other branches are also available:
 ...
 - The [`swift3`](https://github.com/emaloney/CleanroomASL/tree/swift3) branch uses **Swift 3.0**, requiring Xcode 8.0
